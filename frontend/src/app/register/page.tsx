      ...
      <section className="relative z-10 grid w-full grid-cols-1 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="flex min-h-[42vh] flex-col justify-between px-6 py-8 sm:px-10 lg:min-h-screen lg:px-14 lg:py-12">
          ...
          <div className="max-w-2xl py-16 lg:py-0">
            <p className="mb-5 text-sm font-semibold uppercase tracking-[0.28em] text-[#b46533]">
              Private graph workspace
            </p>
            <h1 className="text-balance text-5xl font-semibold tracking-[-0.06em] text-[#162017] sm:text-6xl lg:text-7xl">
              Build a second brain that keeps its sources close.
            </h1>
            <p className="mt-6 max-w-xl text-pretty text-base leading-7 text-[#4f5a50] sm:text-lg">
